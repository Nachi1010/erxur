...
export const Article = () => {
  ...
  const content = {
    ...
    he: {
      title: "על המהפכה",
      mainText: [
        "תכנית הגיוס הייחודית של close.ai\"TM\" -אחת מעשרת חברות ה-AI הצעירות והצומחות בישראל פותחה באופן ייעודי למדעי ה-AI בידי מומחי הוראה ידועי-שם ומדעני AI בינלאומיים. במהלך שנת לימודים אחת דחוסה ואינטנסיבית - משתתפי התכנית הופכים למפתחי AI מן המניין עם ידע מקיף ושווה ערך לבוגרי שלשה תארים במתמטיקה, מדעי המחשב והנתונים ומדעי המוח.",
        
        "הקורס עוצב תוך התמקדות מיוחדת בנטרול של \"רעשי רקע\", בהתכתבות מתמדת עם צרכי התעשייה הדינמיים. מושקעת חשיבה רבה בהקניית יכולות אוטודידקטיות ואנליטיות, שיאפשרו לכם התמודדות ל-long shot עם כל טכנולוגיה/פרויקט/משימה בתחום המתפתח תמידית. לאורך (כמעט) כל הקורס, נרכוש את הידע הנדרש בשילוב \"hands-on\" ותוך יצירה והשתתפות בפרוייקטים חיים ואמיתיים שייצרו עבורנו ניסיון ותיק עבודות שווי ערך לשנתיים-שלש של ניסיון מעשי.",
        
        "מתודולוגיית הלימודים החדשנית והמצליחה שנחשבת לסוד מסחרי רשום של close.aiTM, פותחה בשיתוף חברות AI נוספות ומובילות שוק בכדי לענות על צרכיה הקיומיים של תעשיית ה-AI לענפיה השונים הצמאה לכח אדם איכותי ומוכשר. להכשרה יתקבלו אך ורק מועמדים עם תכונות אישיות ואינטלקטואליות שיאפשרו לנו להציע להם בלב שלם חתימה על חוזה מפורש מראש, ובו התחייבות לתעסוקה בחברתנו עם סיום הקורס."
      ]
    }
  };
